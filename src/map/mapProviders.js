...
um Risiken zu reduzieren oder nachhaltige Ziele zu erreichen.`
    ...
    GEOPOL: {
        ...
        summaryMap: {
            ...
            de: 'Eine geopolitische Karte um geographische Effekte zur Politik zu studieren (Human, physikalisch, Grenzen etc.)'
        },
        icon: {}
    },
    TOPO: {
        ...
        summaryMap: {
            ...
            de: 'Topographische Karte, die unterschiedliche Höhe und Landschaft mit Konturlinien zeigt.'
        },
        icon: {}
    },
    TERRAIN: {
        name: 'TerrainMap',
        summaryMap: {
            en: 'A phyisical map which shows different features of a location usually by color characteristics.',
            de: 'Eine physikalische Karte, die unterschiedliche Geo-Features normalerweise farbig kennzeichnet.'
        },
        icon: {}
    },
    SAT: {
    ...
    WEATHER: {
        summaryMap: {
            en: 'A weather map shows info about the weather of different areas, e.g. by pictograms.',
            de: 'Eine Wetterkarte, die Unterschiede der Wetters in verschiedenen Gebieten zeigt, z. b. Piktogramme.'
        },
        icon: {}
    },
    ECONOMIC: {
    ...
    BOAT: {
        name: 'NauticalMap',
        summaryMap: {
            en: 'Shows marine bathymetry, features ocean or inland waters for boats, ships, water vehicles.',
            de: 'Zeigt Marine Bathymetrie, Ozeane, Binnengewässer für Boote, Schiffe, Wasserfahrzeuge.'
        },
        icon: {}
    },
    AIR: {
...
for (let key in TAG) {
    if (!TAG[key].hasOwnProperty('id')) {
        TAG[key].id = `https://redaktor.me/data/ontology/${TAG[key].name}`;
    }
}
function ORG(name) { return { id: '', type: 'Organization', name }; }
function OSMlayerORG(name, url) {
    return Object.assign(Object.assign({}, ORG(name)), { url, summaryMap: {
...
const actor = {
    OSM: Object.assign(Object.assign({}, ORG('OSM, OpenStreetMap')), { url: 'https://www.openstreetmap.org/', summaryMap: {
            en: `${C.C_OSM} contributors`,
            de: `${C.C_OSM} Mitwirkende`,
        } }),
    OTM: Object.assign(Object.assign({}, ORG('OpenTopoMap - Erhardt, Hochreuther, Schütz')), { url: 'https://www.opentopomap.org/', summary: `(c) [OTM](https://opentopomap.org) ${C.CC}` }),
    SRTM: Object.assign(Object.assign({}, ORG('SRTM - de Ferranti BA')), { url: 'http://viewfinderpanoramas.org/', summary: `(c) [SRTM](http://viewfinderpanoramas.org)` }),
    CARTO: Object.assign(Object.assign({}, ORG('CARTO – Unlock the power of spatial analysis')), { url: 'http://carto.com/', summary: `(c) [CARTO](https://carto.com/attributions)` }),
    CYCLOSM: Object.assign(Object.assign({}, ORG('CyclOSM – OpenStreetMap')), { url: 'https://github.com/cyclosm/', summary: `[CyclOSM](https://github.com/cyclosm/cyclosm-cartocss-style/releases)` }),
    ESRI: Object.assign(Object.assign({}, ORG('Esri – The Science of Where')), { url: 'https://www.esri.com/', summary: `Tiles (c) [Esri](https://www.esri.com/)` }),
    STADIA: Object.assign(Object.assign({}, ORG('Stadia Maps')), { url: 'https://stadiamaps.com/', summary: `(c) [Stadia Maps](https://stadiamaps.com/)` }),
    STAMEN: Object.assign(Object.assign({}, ORG('stamen')), { url: 'http://maps.stamen.com/', summary: `Map tiles by [Stamen Design](http://stamen.com) ${C.CC}` }),
    WIKIMEDIA: Object.assign(Object.assign({}, ORG('Wikimedia Foundation')), { url: 'https://www.wikimedia.org/', summary: '[Wikimedia](https://wikimediafoundation.org/wiki/Maps_Terms_of_Use)' }),
    WIKIMEDIALABS: Object.assign(Object.assign({}, ORG('Wikimedia Foundation')), { url: 'https://www.mediawiki.org/wiki/Wikimedia_Labs/', summary: 'Wikimedia Labs' }),
    NASA: Object.assign(Object.assign({}, ORG('NASA, United States National Space Agency')), { url: 'https://nasa.gov', summary: 'NASA' }),
    USGS: Object.assign(Object.assign({}, ORG('USGS, United States Geological Survey')), { url: 'https://www.usgs.gov/', summary: 'USGS' }),
    OPENSEAMAP: Object.assign(Object.assign({}, ORG('OpenSeaMap')), { url: 'http://www.openseamap.org/', summaryMap: {
            en: `(c) [OpenSeaMap](http://www.openseamap.org) contributors`,
            de: `(c) [OpenSeaMap](http://www.openseamap.org) Mitwirkende`,
        } }),
    OPENPTMAP: Object.assign(Object.assign({}, ORG('OpenPtMap')), { url: 'http://www.openptmap.org/', summaryMap: {
...
for (let key in actor) {
    actor[key].id = `https://redaktor.me/data/Map/actor_${key}`;
}
function concatMaps(...strMaps) {
    const first = typeof strMaps[0] === 'string' ? { en: strMaps[0] } : strMaps[0];
    return strMaps.reduce((o, m) => {
        if (typeof m === 'string') {
            for (let k in o) {
                o[k] += m;
            }
        ...
        for (let k in m) {
            o[k] = o.hasOwnProperty(k) ? `${o[k]} ${m[k]}` :
                (o.hasOwnProperty('en') ? `${o.en} ${m[k]}` : m[k]);
        }
        for (let k in o) {
...
const getESRIvectors = (name = {
    en: 'Esri: World Street Map',
    de: 'Esri: Weltstraßenkarte'
}, styleId = 'de26a3cf4cc9451298ea173c4b324736', attribution = `GDI-TH, Esri, HERE, Garmin, FAO, NOAA, USGS`) => (Object.assign(Object.assign({}, major.ESRI), { preview: `https://www.arcgis.com/home/item.html?id=${styleId}`, [typeof name === 'string' ? 'name' : 'nameMap']: name, url: 'https://basemaps.arcgis.com/v1/arcgis/rest/services/World_Basemap/VectorTileServer/tile/{z}/{y}/{x}.pbf', attributedTo: [actor.ESRI, C.SUMMARY.source, { type: 'Group', summary: attribution }], attachment: [{
            type: ['Document', 'StyleJSON'],
            url: `${B.ESRI_S_PREFIX}${styleId}${B.ESRI_S_SUFFIX}`
        }] }));
const basemap = {
    OSM: major.OSM,
    OSM_DE: Object.assign(Object.assign({}, major.OSM), { name: 'OpenStreetMap DE', preview: 'https://openstreetmap.de', url: 'https://{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png', tag: [TAG.TERRAIN, TAG.CAR, TAG.PARKING], contentMap: concatMaps(major.OSM.contentMap, {
        ...
        }), attributedTo: [actor.OSM, { type: 'Group', summary: `(c) OpenStreetMap Deutschland` }], height: 18 }),
    OSM_FR: Object.assign(Object.assign({}, major.OSM), { name: 'OpenStreetMap FR', preview: 'https://openstreetmap.fr', url: 'https://{s}.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png', tag: [TAG.TERRAIN, TAG.CAR, TAG.PARKING], contentMap: concatMaps(major.OSM.contentMap, 'FR fork'), attributedTo: [actor.OSM, { type: 'Group', summary: `(c) OpenStreetMap France` }], height: 20 }),
    OSM_HOT: Object.assign(Object.assign({}, major.OSM), { name: 'OpenStreetMap HOT', preview: 'https://www.hotosm.org', url: 'https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png', tag: [TAG.TERRAIN, TAG.HUM], contentMap: {
...
durch hohen Kontrast und ausgewogene Signaturen.`
    ...
    ESRI_WORLDSTREETMAP: Object.assign(Object.assign({}, getESRIvectors()), { tag: [TAG.CAR, TAG.PARKING], contentMap: {
...
Bietet eine detailierte Welt-Basiskarte mit einem klassischen Esri Straßenkarten Stil.`
    ...
    ESRI_OPENSTREETMAP: Object.assign(Object.assign({}, getESRIvectors('Esri Open Street Map', '3e1a00aeae81496587988075fe529f71', '')), { tag: [TAG.TERRAIN, TAG.CAR, TAG.PARKING], contentMap: {
...
Diese Vektor-Grundkarte wird von Esri bereitgestellt.`
    ...
    ESRI_OCEAN: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Ocean Basemap',
        de: 'Esri: Ozeanische Grundkarte'
    }, 'f0c119410f5e4d54be7545657f9768cb', 'OceanWise, Esri, GEBCO, DeLorme, NaturalVue | Esri UK, Esri, HERE, Garmin, FAO, METI/NASA, USGS')), { tag: [TAG.TOPO, TAG.BOAT], contentMap: {
...
Zu den Landmerkmalen gehören Binnengewässer und überlappende Straßen sowie schattierte Reliefbilder.`
    ...
    ESRI_TOPOGRAPHIC: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Topographic Basemap',
        de: 'Esri: Topografische Grundkarte'
    }, '7a6bf0e8cb5a418085e66c0485e74d19', major.ESRI.attr1)), { tag: [TAG.TOPO], contentMap: {
...
Topografiekarten Stil, gestaltet zur Benutzung mit einer erhabenen Karte.`
    ...
    ESRI_TERRAIN: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Terrain Basemap',
        de: 'Esri: Gelände Grundkarte'
    }, '33064a20de0c48d2bb61efa8faca93a8', major.ESRI.attr2)), { tag: [TAG.TERRAIN], contentMap: {
...
Gestaltet als Basisebene für die 'World Terrain' Referenz-Ebene und hillshade.`
    ...
    ESRI_COMMUNITY: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Community Basemap',
        de: 'Esri: Community Grundkarte'
    }, '273bf8d5c8ac400183fc24e109d20bcf')), { tag: [TAG.TERRAIN, TAG.CAR, TAG.PARKING, TAG.WALK, TAG.TRANSIT], contentMap: {
    ...
    ESRI_NATGEO: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Basemap National Geographic Style',
        de: 'Esri: Grundkarte National Geographic Stil'
    }, '3d1a30626bbc46c582f148b9252676ce', major.ESRI.attr2)), { tag: [TAG.GEOPOL, TAG.TOPO, TAG.TERRAIN], contentMap: {
...
und einem Hintergrund, der den physikalischen Boden-Charakter unterstreicht.`
    ...
    ESRI_STREETNIGHT: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Streets at night',
        de: 'Esri: Straßen bei Nacht'
    }, '93554006894c45a88136127535878fca')), { tag: [TAG.CAR, TAG.DARK], contentMap: {
...
Bietet eine detailierte Welt-Basiskarte mit einem angepaßten 'Bei Nacht' Straßenkarten Stil.`
    ...
    ESRI_NAVIGATION: Object.assign(Object.assign({}, getESRIvectors('Esri: Navigation', '63c47b7177f946b49902c24129b87252')), { tag: [TAG.CAR, TAG.PARKING], contentMap: {
...
Bietet eine detailierte Ansicht der Welt mit einem Navigationskarten-Stil.`
    ...
    ESRI_GRAY: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Light Gray Canvas',
        de: 'Esri: Hellgraue Leinwand'
    }, '291da5eab3a0412593b66d384379f89f')), { tag: [TAG.LIGHT], contentMap: {
...
und minimalen Farben inklusive Beschriftung.`
    ...
    ESRI_GRAY_DARK: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Darkgray Canvas',
        de: 'Esri: Dunkelgraue Leinwand'
    }, '5e9b3685f4c24d8781073dd928ebda50')), { tag: [TAG.DARK], contentMap: {
...
und minimalen Farben inklusive Beschriftung.`
    ...
    ESRI_HUMANGEO: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Human Geography',
        de: 'Esri: Humangeographie'
    }, '2afe5b807fa74006be6363fd243ffb30')), { tag: [TAG.LIGHT, TAG.CONTRAST, TAG.HUM], contentMap: {
...
Der Inhalt unterstreicht humangeographische Informationen.`
    ...
    ESRI_HUMANGEO_DARK: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Human Geography, dark',
        de: 'Esri: Humangeographie, dunkel'
    }, 'd7397603e9274052808839b70812be50')), { tag: [TAG.DARK, TAG.CONTRAST, TAG.HUM], contentMap: {
...
Der Inhalt unterstreicht humangeographische Informationen.`
    ...
    ESRI_NEWSPAPER: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Newspaper',
        de: 'Esri: Zeitung'
    }, 'dfb04de5f3144a80bc3f9f336228d24a')), { tag: [TAG.GEOPOL, TAG.CAR, TAG.ART], contentMap: {
...
mit Halbtonmustern, roten Highlights und stilisierten Schriftarten.`
    ...
    ESRI_NOVA: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Nova',
        de: 'Esri: Nova'
    }, '75f4dfdff19e445395653121a95a85db')), { tag: [TAG.ART, TAG.DARK], contentMap: {
...
und einer leuchtend blauen Symbologie.`
    ...
    ESRI_COLOREDPENCIL: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Colored Pencil',
        de: 'Esri: Farbstift'
    }, '4cf7e1fb9f254dcda9c8fbadb15cf0f8')), { tag: [TAG.GEOPOL, TAG.ART], contentMap: {
...
Dieses Vektor Tile Layer wird im Stil einer handgezeichneten Buntstiftkartographie präsentiert.`
    ...
    ESRI_BLUEPRINT: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Blueprint',
        de: 'Esri: Blaupause'
    }, '80be160f0ca1413d898ad4e90d197278')), { tag: [TAG.ART, TAG.CONTRAST], contentMap: {
...
der eine technische Blaupausenzeichnung emuliert.`
    ...
    ESRI_MIDCENTURY: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Mid Century',
        de: 'Esri: Die 50er Jahre'
    }, '7675d44bb1e4428aa2c30a9b68f97822')), { tag: [TAG.HISTORY], contentMap: {
...
Vektorstil eine einzigartige Designoption für die ArcGIS-Grundkarten.`
    ...
    ESRI_MODERNANTIQUE: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Modern Antique',
        de: 'Esri: Modern Antik'
    }, 'effe3475f05a4d608e66fd6eeb2113c0')), { tag: [TAG.HISTORY], contentMap: {
...
Diese Karte wurde für die Verwendung mit World Hillshade entwickelt.`
    ...
    ESRI_CHARTEDTERRITORY: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Charted Territory',
        de: 'Esri: Kartiertes Gebiet'
    }, '1c365daf37a744fbad748b67aa69dac8')), { tag: [TAG.GEOPOL], contentMap: {
...
Wandkarte erinnert. Diese Schicht ist für die Verwendung mit schattiertem Relief vorgesehen.`
    ...
    */
    ...
    CARTO_POSITRON: Object.assign(Object.assign({}, major.CARTO), { name: 'CARTO Positron', url: `${B.CARTO}light_all${C.RET}`, tag: [TAG.LIGHT], contentMap: {
    ...
    CARTO_DARKMATTER: Object.assign(Object.assign({}, major.CARTO), { name: 'CARTO Dark Matter', url: `${B.CARTO}dark_all${C.RET}`, tag: [TAG.DARK], contentMap: {
...
const layer = {
    ESRI_HYBRID_REF: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Hybrid Reference Layer',
        de: 'Esri: Hybride Referenzebene'
    }, '30d6b8271e1849cd9c3042060001f425')), { tag: [TAG.LABELS], contentMap: {
...
Bietet eine detailierte Referenzebene, gestaltet um auf Bebilderung oder Leinwände gelegt zu werden.`
        }, hasBaseMap: ['ESRI_WORLDIMAGERY', 'ESRI_TOPOGRAPHIC', 'ESRI_TERRAIN'], attachment: [{
                type: "Question",
                oneOf: [
    ...
    ESRI_STREETNIGHT_REF: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: "Streets at night" Reference Layer',
        de: 'Esri: "Straßen bei Nacht" Referenzebene'
    }, '93554006894c45a88136127535878fca')), { tag: [TAG.LABELS], contentMap: {
...
Bietet eine detailierte Referenzebene, gestaltet um auf dunkle Karten gelegt zu werden.`
        }, hasBaseMap: 'ESRI_STREETNIGHT', attachment: [{
                type: "Question",
                oneOf: [
    ...
    ESRI_GRAY_REF: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Light Gray Canvas, Reference Layer',
        de: 'Esri: Hellgraue Leinwand, Referenzebene'
    }, '1768e8369a214dfab4e2167d5c5f2454')), { tag: [TAG.LABELS], contentMap: {
...
Gestaltet zur Benutzung mit "Hellgraue Leinwand" Basis.`
        }, hasBaseMap: 'ESRI_GRAY', attachment: [{
                type: "Question",
                oneOf: [
    ...
    ESRI_GRAY_DARK_REF: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Darkgray Canvas, Reference Layer',
        de: 'Esri: Dunkelgraue Leinwand, Referenzebene'
    }, '747cb7a5329c478cbe6981076cc879c5')), { tag: [TAG.LABELS], contentMap: {
...
Gestaltet zur Benutzung mit "Dunkelgraue Leinwand" Basis.`
        }, hasBaseMap: 'ESRI_GRAY_DARK', attachment: [{
                type: "Question",
                oneOf: [
    ...
    ESRI_HUMANGEO_DETAIL: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Human Geography, Detail Layer',
        de: 'Esri: Humangeographie, Detailebene'
    }, '97fa1365da1e43eabb90d0364326bc2d')), { tag: [TAG.TERRAIN], contentMap: {
...
Diese Ebene wurde gestaltet zur Benutzung mit "Humangeographie" Beschriftung und Basisebene.`
    ...
    ESRI_HUMANGEO_REF: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Human Geography, Label',
        de: 'Esri: Humangeographie, Beschriftung'
    }, 'ba52238d338745b1a355407ec9df6768')), { tag: [TAG.LABELS], contentMap: {
            en: `The World Basemap v2 - Human Geography map
...
Diese Ebene wurde gestaltet zur Benutzung mit "Humangeographie" Detail und Basisebene.`
        }, hasBaseMap: 'ESRI_HUMANGEO', attachment: [{
                type: "Question",
                oneOf: [
    ...
    ESRI_HUMANGEO_DARK_DETAIL: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Human Geography, dark, Detail Layer',
        de: 'Esri: Humangeographie, dunkel, Detailebene'
    }, '1ddbb25aa29c4811aaadd94de469856a')), { tag: [TAG.TERRAIN], contentMap: {
...
Diese Ebene wurde gestaltet zur Benutzung mit "Humangeographie dunkel" Beschriftung und Basisebene.`
    ...
    ESRI_HUMANGEO_DARK_REF: Object.assign(Object.assign({}, getESRIvectors({
        en: 'Esri: Human Geography, dark, Label',
        de: 'Esri: Humangeographie, dunkel, Beschriftung'
    }, '4a3922d6d15f405d8c2b7a448a7fbad2')), { tag: [TAG.LABELS], contentMap: {
            en: `The World Basemap v2 - Human Geography map, dark
...
Diese Ebene wurde gestaltet zur Benutzung mit "Humangeographie dunkel" Detail und Basisebene.`
        }, hasBaseMap: 'ESRI_HUMANGEO_DARK', attachment: [{
                type: "Question",
                oneOf: [
...
function getContext(mapType = 'MapLayer') {
    const extContext = { tag: `${arcoBase}SiteType`, mapContext: `${arcoBase}TypeOfContext` };
    if (mapType === 'MapLayer') {
...
function getMap(name, orderedItems) {
...
const ProviderItems = [basemap, layer].reduce((a, o, i) => {
    for (let key in o) {
        ...
        if (o[key].hasOwnProperty('hasBaseMap')) {
            ...
            o[key].hasBaseMap = o[key].hasBaseMap.map((baseKey) => {
