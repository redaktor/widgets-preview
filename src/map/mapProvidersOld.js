...
und minimalen Farben inklusive Beschriftung.`
    ...
    }, '2afe5b807fa74006be6363fd243ffb30')), { tag: [TAG.LIGHT, TAG.CONTRAST], contentMap: {
...
Der Inhalt unterstreicht humangeographische Informationen.`
    ...
    }, 'd7397603e9274052808839b70812be50')), { tag: [TAG.DARK, TAG.CONTRAST], contentMap: {
...
/*
'@context': { oneOf: 'https://w3id.org/arco/ontology/location/isBaseMapOf' },
// TODO: "CLIMATE","WEATHER","ECONOMIC","TRANSIT","AIR"
*/
const layer = {
...
const ProviderItems = [basemap, layer].reduce((a, o, i) => {
    for (let key in o) {
      console.log(key, o[key].tag.map((x)=>x.name));
