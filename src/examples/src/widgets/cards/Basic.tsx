...
const nameMap = {en: "It is on! The season is officially open!", de: "Es ist an! Die Saison ist eröffnet!"};
...
const actionButtons = <virtual>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="link" /></Button>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="like" /></Button>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="bookmark" /></Button>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="share" /></Button>
	<noscript><Button spaced={false} responsive={true}><Icon size="xxl" type="comment" /></Button></noscript>
	<Icon spaced={false} type="more" />
</virtual>
const actionButtons2 = <virtual>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="update" /></Button>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="_delete" /></Button>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="bookmark" /></Button>
	<Button spaced={false} responsive={true}><Icon size="xxl" type="move" /></Button>
	<Icon spaced={false} type="more" />
</virtual>
...
export default factory(function CardWithMediaRectangle() {
	...
	return (
		<Cards>
		{{
			aside: <div classes={asideCss.root}>
				<Details open={true} summary="Most read">
					<ol classes={[asideCss.container, asideCss.mostread]}>
						<li tabindex="0" classes={asideCss.item}>
							...
							<span classes={asideCss.caption}>Lorem Ipsum Lorem Ipsum Lorem Ipsum dolor sunt lorem ipsum lorem ipsum max 5 lines</span>
						</li>
						<li tabindex="0" classes={asideCss.item}>
					...
					<br />
					<Button><Icon size="l" spaced={false} type="view" /> All</Button>
				</Details>
				<Details open={true} summary="Federate">
					...
					<ul classes={[asideCss.container, asideCss.federate]}>
						<li classes={[asideCss.item, asideCss.top]}>
							<div classes={asideCss.avatar}><Avatar spaced={false}>AP</Avatar></div>
							<span classes={asideCss.rows}>
								<span classes={asideCss.name}>Alyssa P. Hacker</span><br />
								<small classes={asideCss.handle}>alyssa@chaos.social</small>
								<Button spaced={false} variant="outlined">Follow</Button>
							</span>
						</li>
						<li classes={[asideCss.item, asideCss.top]}>
							<div classes={asideCss.avatar}><Avatar spaced={false}>BB</Avatar></div>
							<span classes={asideCss.rows}>
								<span classes={asideCss.name}>Ben Bitdiddle</span><br />
								<small classes={asideCss.handle}>@ben@octodon.social</small>
								<Button spaced={false} variant="outlined">Follow</Button>
							</span>
						</li>
						<li classes={[asideCss.item, asideCss.top]}>
							<div classes={asideCss.avatar}><Avatar spaced={false}>ED</Avatar></div>
							<span classes={asideCss.rows}>
								<span classes={asideCss.name}>Ed</span><br />
				...
				<Details open={true} summary="Trending Tags">
					<ol classes={[asideCss.container, asideCss.tags]}>
						<li classes={asideCss.item}>
							<div classes={asideCss.graph}></div>
							<span classes={asideCss.tag}>
								supertag<br /><small classes={asideCss.tagCount}><b>382</b><span> reden drüber</span></small>
							</span>
						</li>
						<li classes={asideCss.item}>
							<div classes={asideCss.graph}></div>
							<span classes={asideCss.tag}>cooltag<br /><small classes={asideCss.tagCount}><b>342</b><span> reden drüber</span></small></span>
						</li>
						<li classes={asideCss.item}>
							<div classes={asideCss.graph}></div>
							<span classes={asideCss.tag}>3tag<br /><small classes={asideCss.tagCount}><b>287</b><span> reden drüber</span></small></span>
						</li>
						<li classes={asideCss.item}>
							<div classes={asideCss.graph}></div>
							<span classes={asideCss.tag}>othertag<br /><small classes={asideCss.tagCount}><b>40</b><span> reden drüber</span></small></span>
						</li>
						<li classes={asideCss.item}>
							<div classes={asideCss.graph}></div>
							<span classes={asideCss.tag}>incredibleFive<br /><small classes={asideCss.tagCount}><b>5</b><span> reden drüber</span></small></span>
						</li>
					</ol>
					<br />
					<Button><Icon size="l" spaced={false} type="view" /> All</Button>
					...
					<ul classes={[asideCss.container, asideCss.topics]}>
						<li classes={[asideCss.item, asideCss.rows]}>
							<span classes={asideCss.topic}>
								b&w photography<br />
								<small classes={asideCss.topicCount}><b>82</b><span> neu / 1238</span></small>
							</span>
							<div classes={asideCss.topicImage}></div>
						</li>
						<li classes={[asideCss.item, asideCss.rows]}>
							<span classes={asideCss.topic}>
								webdesign<br />
								<small classes={asideCss.topicCount}><b>40</b><span> neu / 761</span></small>
							</span>
							<div classes={asideCss.topicImage}></div>
						</li>
						<li classes={[asideCss.item, asideCss.rows]}>
							<span classes={asideCss.topic}>
								rare stamps<br />
								<small classes={asideCss.topicCount}><span>22</span></small>
							</span>
							<div classes={asideCss.topicImage}></div>
						</li>
					</ul>
			...
			content: <virtual>
				...
				<Card {
					...{
						...
						aspectRatio: '3:2',
						type: 'note',
						summary: '2: note w. image and summary: \n'+summary,
						content: summary
					}
				}>
					{{ avatar, actionButtons }}
				...
				<Card {
					...
					{{ avatar, actionButtons: actionButtons2 }}
				</Card>
